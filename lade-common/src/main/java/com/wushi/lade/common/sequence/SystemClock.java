package com.wushi.lade.common.sequence;

/**
 * @ClassName SystemClock
 * @Description 利用ScheduledExecutorService实现高并发场景下System.curentTimeMillis()的性能问题的优化.
 * @Version 1.0
 */
...
public enum SystemClock {
    ...
    public void initialize() {
        ...
        this.executorService = new ScheduledThreadPoolExecutor(1, r -> {
            Thread thread = new Thread(r, "sup-clock");
